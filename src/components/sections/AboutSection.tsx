        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              שירן שושני - חברת עורכי דין, נוטריון וגישור, מלווה לקוחות פרטיים ועסקיים במגוון רחב של תחומי המשפט. אנו מתמחים במתן ייעוץ וייצוג משפטי ברמה הגבוהה ביותר, לצד שירותי נוטריון וגישור, תוך שמירה על ערכים של מקצועיות, יושרה ומחויבות מלאה ללקוחותינו.
            </p>
